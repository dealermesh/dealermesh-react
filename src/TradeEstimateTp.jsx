...
import { DMField, DMTradeForm, DM_EVENT_TRADE_ESTIMATE, DM_EVENT_TRADE_VEHICLE_UPDATE, DM_FIELDS, DM_TRADE_STEP_MILES, useDMEventListener } from "@dealermesh/react";
import Layout from "./Layout";

export default function TradeEstimateTp(props) {
      ...
      <DMTradeForm className="sections">
        ...
        <section>
          <div className="form">
            ...
            <div>
              <label>Zip*</label>
              <DMField name={DM_FIELDS.TRADE_VEHICLE_ZIP}></DMField>
            </div>
            <div>
